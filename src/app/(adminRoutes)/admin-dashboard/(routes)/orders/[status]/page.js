...
import ConsignmentSlip from "@/components/AdminDashboard/Order/ConsignmentSlip/ConsignmentSlip.js";
import OrdersTable from "@/components/AdminDashboard/Products/Orders/OrdersTable/OrdersTable.js";
          ...
          <div className="px-6 py-4 border-t border-gray-200 bg-gray-50/50">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-sm text-gray-600">
                Showing 1 to {Math.min(10, orders?.length || 0)} of{" "}
